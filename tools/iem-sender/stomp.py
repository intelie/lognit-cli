...
class Connection(object):
    ...
    def __init__(self, 
        ...
        \param max_attempts
                ...
                Number of times that hosts tries to connect.
                Set to -1 to try forever.
    ...
    def __attempt_connection(self):
        ...
        lock.acquire(1)
        attempt = self.__max_attempts
        
        log.debug('Init connection')
        
        try:
            sleep_exp = 1
            while self.__running and self.__socket is None and attempt != 0 :
                attempt = attempt - 1
                ...
                if self.__socket is None:
                    ...
                    sleep_exp += 1
            if attempt == 0:
              log.info("Max attempts of connection reached: %i " % self.__max_attempts)
        finally:
            lock.release()           
